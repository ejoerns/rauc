...
root = pytest.mark.skipif(os.geteuid() != 0, reason="Have no root")
...
def select_system_or_session_bus():
    ...
    try:
        ...
        # Now you can access the environment variables in your Python script
        dbus_session_bus_address = os.environ.get("DBUS_SESSION_BUS_ADDRESS")
        if dbus_session_bus_address:
            print(f"DBUS_SESSION_BUS_ADDRESS: {dbus_session_bus_address}")

    except subprocess.CalledProcessError as e:
        print(f"Error running dbus-launch: {e}")
