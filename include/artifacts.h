...
typedef struct _RArtifact {
	...
	/** orginal contents of the artifact */
...
/**
 * Insert an existing RArtifact into the repository.
 *
...
/**
 * Remove unreferenced artifacts and inconsistent data such as partitial
 * downloads.
 *
...
/**
 * Initialize artifact functionality by calling prepare and cleanup for all
