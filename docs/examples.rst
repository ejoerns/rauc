...
slots* can be useful for systems with one or several larger data files (e.g.
map data) that should be updated more frequently and independently of the main
A/B rootfs.
...
The artifacts folder ``maps`` from this example must be located on a separate
