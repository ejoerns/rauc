...
static void service_test_install(ServiceFixture *fixture, gconstpointer user_data)
{
	...
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",   0, "Checking bundle", 2));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",   0, "Verifying signature", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  25, "Verifying signature done.", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  25, "Checking bundle done.", 2));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  25, "Verifying manifest", 2));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  25, "Loading manifest file", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  37, "Loading manifest file done.", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  37, "Verifying manifest checksums", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  50, "Verifying manifest checksums done.", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  50, "Verifying manifest done.", 2));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  50, "Determining target install group", 2));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  75, "Determining target install group done.", 2));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  75, "Updating slots", 2));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  75, "Checking slot rootfs.1", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  81, "Checking slot rootfs.1 done.", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  81, "Copying image", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  87, "Copying image done.", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  87, "Checking slot appfs.1", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  93, "Checking slot appfs.1 done.", 3));
	g_queue_push_tail(args, (gpointer*)g_variant_new("(isi)",  93, "Copying image", 3));
